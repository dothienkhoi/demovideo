...
export default function LandingPage() {
  ...
  const handleNewsletter = (e: React.FormEvent) => {
    ...
    if (email) {
      alert(
        `Cảm ơn bạn đã đăng ký! Chúng tôi sẽ gửi thông tin khuyến mãi đến ${email}`
      );
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 relative overflow-y-auto scroll-smooth font-sans antialiased transition-all duration-500 pt-24">
        ...
        <header
          className={`fixed top-0 left-0 right-0 z-50 w-full flex items-center justify-between p-6 transition-all duration-300 ease-in-out ${
            isScrolled
        ...
        >
          ...
          <div className="flex items-center gap-3 group cursor-pointer">
            <div
              ...
              } bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300`}
            >
              <MessageCircle
                className={`${
            ...
            <span
              ...
              } font-bold transition-all duration-300 font-sans leading-tight`}
            >
        ...
        <section
          className="relative z-10 py-20 lg:py-28 px-6 lg:px-8"
          data-aos="fade-up"
        >
            ...
            <div className="grid lg:grid-cols-2 gap-20 lg:gap-24 items-center">
              ...
              <div className="space-y-10 pr-8 lg:pr-16" data-aos="fade-right">
                ...
                <p className="mt-6 text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-xl font-sans">
                  Nền tảng giúp bạn chia sẻ thông tin trong nhóm, làm việc hiệu
                  quả và luôn cập nhật.
                </p>
              </div>

              <div
                className="relative select-none pl-4 lg:pl-8"
                data-aos="fade-left"
              >
                <div
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end p-6">
                    <div className="text-white">
                      ...
                      <p className="text-sm opacity-90 font-sans">
                        Giao diện tin nhắn sạch sẽ, nhanh chóng
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="aspect-video bg-gradient-to-br from-green-500/20 to-teal-500/20 dark:from-green-400/10 dark:to-teal-400/10 rounded-2xl overflow-hidden shadow-2xl group-hover:shadow-3xl group-hover:shadow-green-500/20 dark:group-hover:shadow-green-400/20 transition-all duration-300">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end p-6">
                    <div className="text-white">
                      ...
                      <p className="text-sm opacity-90 font-sans">
                        Cuộc gọi video HD với chia sẻ màn hình
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed font-sans">
                  Nhận thông báo khi có bài đăng mới, bình luận, lượt thích hoặc
                  khi bạn được nhắc tên trong cuộc trò chuyện của nhóm.
                </p>
              </div>
            ...
            <div className="mb-16">
              <div className="inline-block mb-6">
                <div className="flex items-center gap-2 bg-indigo-500/10 px-4 py-2 rounded-full border border-indigo-500/20 backdrop-blur-sm">
                  ...
                  <span className="text-sm text-indigo-400 font-medium font-sans">
                    TÙY BIẾN GIAO DIỆN
                  </span>
                </div>
              </div>
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto font-sans">
                Đồng bộ thương hiệu của bạn cho tất cả phòng chat và bảng tin.
                Hỗ trợ Dark/Light mode, màu chủ đề nhóm, hình nền, avatar và
                nhãn vai trò thành viên.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 text-blue-600 dark:text-blue-400 font-sans">
                  Tin Nhắn Riêng Tư
                </h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-sans">
                  Trò chuyện một-một an toàn với mã hóa đầu cuối và gửi tin nhắn
                  thời gian thực.
                </p>
              </div>
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 text-purple-600 dark:text-purple-400 font-sans">
                  Nhóm Chat
                </h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-sans">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 text-green-600 dark:text-green-400 font-sans">
                  Cuộc Gọi Video
                </h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-sans">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 text-orange-600 dark:text-orange-400 font-sans">
                  Bài Đăng Nhóm
                </h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-sans">
                  Chia sẻ thông báo, cập nhật và nội dung trong nhóm của bạn như
                  một bảng tin xã hội riêng tư.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative backdrop-blur-16 bg-white/95 dark:bg-gray-800/20 border border-gray-200/60 dark:border-gray-700/40 rounded-3xl p-12 text-center">
                ...
                <p className="text-xl mb-12 text-gray-700 dark:text-gray-300 leading-relaxed font-sans">
                  Tham gia cùng đội nhóm đang sử dụng FastBite Group để làm việc
                  hiệu quả hơn
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed font-sans">
                  Nền tảng giao tiếp thông minh giúp kết nối, chia sẻ và cộng
                  tác hiệu quả hơn.
                </p>
              ...
              {/* Product Links */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 font-sans">
                  Sản Phẩm
                </h3>
              ...
              <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div className="text-gray-600 dark:text-gray-400 text-center md:text-left">
                  <p className="font-sans">
                    &copy; 2024 FastBite Group. Tất cả quyền được bảo lưu.
                  </p>
                  <p className="text-sm mt-1 font-sans">
                    Kết Nối. Chia Sẻ. Cộng Tác .
                  </p>
                </div>
                <div className="flex flex-wrap justify-center md:justify-end gap-6 text-sm"></div>
              </div>
            </div>
          </div>
        </footer>
      ...
      <Dialog open={isDemoOpen} onOpenChange={setIsDemoOpen}>
        <DialogContent className="max-w-3xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
          <DialogHeader>
            <DialogTitle className="text-gray-900 dark:text-gray-100 font-sans">
              Demo FastBite Group
            </DialogTitle>
          </DialogHeader>
